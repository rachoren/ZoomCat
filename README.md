...
- 🖥️ **Dashboard 仪表盘**：点击猫咪弹出（参考 RunCatNeo 设计语言）
  ...
  - **Claude Code 卡片**：模型 / 上下文用量 / 5h、7d 速率限额（statusLine 钩子，一键配置）
  - 品种画廊（10 品种缩略图点选即换）
  - 毛玻璃质感、明暗模式自适应
...
- 🚶 速度分级：睡觉 😴 / 休息 🧘 / 散步 🚶 / 慢跑 🏃 / 飞奔 💨
- 🎭 **角色系统**（Runner Gallery 风格）：猫咪 / **柴犬**（卷尾巴）/ **兔子**（长耳朵蹦跳）/ **熊猫**（黑眼圈）/ **企鹅**（摇摆走路），一键切换
- 🐱 **10 种高人气猫品种**（萌系卡通化，大头圆眼 + 高光眼神 + 粉鼻腮红）：
  布偶猫 / 英短蓝猫 / 美短虎斑 / 暹罗猫 / 波斯猫 / 缅因猫 / 折耳猫 /
  斯芬克斯 / 豹猫 / 金渐层。选择会被记住
- 😴 **睡觉姿势**：猫咪低负载时蜷成一团睡觉（呼吸起伏 + Zzz）
- 🎨 预览图：`build/previews/runners.png`（5 角色 × 睡觉/端坐/奔跑总览）
